...
本ドキュメントは5374の概要、使用方法について書かれています。
様々な自治体向けカスタマイズについては[HOWTO.md](HOWTO.md)を参照するようにしてください。
...
ここでは[5374 for kanazawa](http://kanazawa.5374.jp/ )について説明します。

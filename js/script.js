...
/*   var descriptions = new Array(); */
  ...
  function updateData(row_index) {
    ...
    //トラッシュの近い順にソートします。
    areaModel.sortTrash();
    var accordion_height = $(".area").height() / descriptions.length;
    if(descriptions.length>4){
      accordion_height = $(".area").height() / 4.1;
      if (accordion_height>140) {accordion_height = $(".area").height() / descriptions.length;};
